...
// si on trouve des vhs partis en loc
if (!empty($recup_kepler_vhs_changed_to_loc_starterre)) {
    foreach ($recup_kepler_vhs_changed_to_loc_starterre as $vh) {
    ...
    sautdeligne();
    echo "Aucun véhicule partis en loc";
}
...
if (!empty($recup_kepler_vhs_changed_to_LAG_starterre)) {
    foreach ($recup_kepler_vhs_changed_to_LAG_starterre as $vh) {
        ...
        if ($id_starterre) {
            ...
            if ($check_state_vh) {
                ...
                $nbr_vh_to_LAG_starterre++;
            }

        }
    }
    sautdeligne();
    echo "nombre de vh partis en LAG: $nbr_vh_to_LAG_starterre";
} else {
    sautdeligne();
